...
![GitBackup 대시보드 화면](/docs/images/git-backup-multi.png)
...
![GitBackup 대시보드 상세](/docs/images/git-backup-multi.png)
...
![GitBackup 설정 화면](/docs/images/git-backup-settings.png)
...
![GitBackup 기존 백업 가져오기 화면](/docs/images/git-backup-get-repository.png)
